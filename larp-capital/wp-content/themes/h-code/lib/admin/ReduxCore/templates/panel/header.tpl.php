...
<div id="redux-header">
    <?php if ( ! empty( $this->parent->args['display_name'] ) ) { ?>
        ...
        <div class="hcode-head-right">
            <?php
            $hcode_live_site_url = 'https://hcode.themezaa.com';
            $hcode_live_support_url = 'https://www.themezaa.com';
            ?>
            <a href="<?php echo esc_url( $hcode_live_site_url ); ?>/documentation/" target="_blank"><?php echo esc_html__('Online Documentation', 'H-Code'); ?></a>
                <span class="link_sep">|</span><a href="<?php echo esc_url( $hcode_live_support_url ); ?>/support/" target="_blank"><?php echo esc_html__('Support Center', 'H-Code'); ?></a>
        </div>
        <div class="clear"></div>
    <?php } ?>
