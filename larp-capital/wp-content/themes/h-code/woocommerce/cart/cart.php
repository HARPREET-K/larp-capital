			...
			<form class="woocommerce-cart-form" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
					...
					?>
						...
						<thead>
							<tr>
								...
								<th class="product-subtotal text-left text-uppercase font-weight-600 letter-spacing-2 text-small black-text"><?php esc_html_e( 'Subtotal', 'woocommerce' ); ?></th>
									...
									<tr class="woocommerce-cart-form__cart-item <?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?>">
										...
										<td class="product-name text-left" data-title="<?php esc_attr_e( 'Product', 'woocommerce' ); ?>">
											<?php
												...
												if ( ! $product_permalink ) {
													echo '<a class="text-small" href="#"><i class="fas fa-edit black-text"></i> '.esc_html__( 'Edit', 'woocommerce' ).'</a>';
												} else {
													echo '<a class="text-small" href="'.esc_url( $product_permalink ).'"><i class="fas fa-edit black-text"></i> '.esc_html__( 'Edit', 'woocommerce' ).'</a>';
												}
											?>
										</td>

										<td class="product-price text-left" data-title="<?php esc_attr_e( 'Price', 'woocommerce' ); ?>">
											<?php
										...
										<td class="product-subtotal text-left" data-title="<?php esc_attr_e( 'Subtotal', 'woocommerce' ); ?>">
											<?php
				...
				<div class="col-sm-12">
					<div class="cupon padding-five border-top border-bottom">
						...
						<a href="<?php echo add_query_arg( 'empty-cart', '', esc_url( wc_get_cart_url() ) ); ?>" class="highlight-button btn btn-very-small no-margin pull-left"><?php esc_html_e('Empty Cart', 'H-Code');?></a>
						<?php do_action( 'hcode_woocommerce_continue_shopping_link' ); ?>
						<button type="submit" class="button  highlight-button btn btn-very-small no-margin pull-right" name="update_cart" value="<?php esc_attr_e( 'Update cart', 'woocommerce' ); ?>"><?php esc_html_e( 'Update cart', 'woocommerce' ); ?></button>
					...
					<div class="panel panel-default border margin-five no-margin-top">
				        <div role="tablist" id="headingOne" class="panel-heading no-padding">
				            <a class="collapsed" data-toggle="collapse" data-parent="#collapse-two" href="#collapse-two-link1">
				                <h4 class="panel-title no-border black-text font-weight-600 letter-spacing-2"><?php esc_attr_e( 'Coupon code', 'woocommerce' ); ?> <span class="pull-right"><i class="fas fa-plus"></i></span></h4>
				            </a>
				        </div>
				        <div id="collapse-two-link1" class="panel-collapse collapse">
				            <div class="panel-body">
								...
								<div class="coupon">
									...
									<button type="submit" class="button highlight-button btn btn-very-small no-margin pull-left" name="apply_coupon" value="<?php esc_attr_e( 'Apply coupon', 'woocommerce' ); ?>"><?php esc_attr_e( 'Apply coupon', 'woocommerce' ); ?></button>
