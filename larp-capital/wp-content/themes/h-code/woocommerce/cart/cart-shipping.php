...
<tr class="shipping">
	<?php if( is_cart() ) { ?> 
	<th class="padding-two text-right no-padding-right text-uppercase font-weight-600 letter-spacing-2 text-small"><?php echo wp_kses_post( $package_name ); ?></th>
	<?php } else { ?>
	<td></td>
	<td class="padding-two text-right no-padding-right text-uppercase font-weight-600 letter-spacing-2 text-small">
		<?php echo wp_kses_post( $package_name ); ?>
	</td>
	<?php } ?>
	<td class="padding-two text-uppercase text-right no-padding-right font-weight-600 black-text text-small shipping-title-text" data-title="<?php echo esc_attr( $package_name ); ?>">
		<?php if ( $available_methods ) : ?>
			<ul id="shipping_method" class="hcode-shipping-method">
