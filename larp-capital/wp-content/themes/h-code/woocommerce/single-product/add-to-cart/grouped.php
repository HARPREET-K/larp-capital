...
<form class="cart grouped_form" action="<?php echo esc_url( apply_filters( 'woocommerce_add_to_cart_form_action', $product->get_permalink() ) ); ?>" method="post" enctype='multipart/form-data'>
	...
	<?php if ( $quantites_required && $show_add_to_cart_button ) : ?>
		...
		<div class="group_single_button_wrap">
			<button type="submit" class="single_add_to_cart_button button alt highlight-button-dark btn-medium btn"><i class="icon-basket"></i><?php echo esc_html( $product->single_add_to_cart_text() ); ?></button>
		</div>
