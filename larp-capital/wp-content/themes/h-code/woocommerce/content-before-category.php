...
switch ($product_category_sidebar_position) {
	case '2':
		echo '<div class="col-md-9 col-sm-8 col-xs-12 xs-margin-bottom-40px product-main-wrapper pull-right">';
		break;
	
	case '3':
		echo '<div class="col-md-9 col-sm-8 col-xs-12 product-main-wrapper xs-margin-bottom-40px">';
		break;

	case '4':
		echo '<div class="col-md-2 col-sm-4 col-xs-12 sidebar sm-margin-bottom-40px">';
		...
		echo '</div>';
		echo '<div class="col-md-8 col-sm-12 col-xs-12 product-main-wrapper xs-margin-bottom-40px">';
		break;

	case '1':
	default:
		echo '<div class="col-md-12 col-sm-12 col-xs-12 product-main-wrapper">';
		break;
}