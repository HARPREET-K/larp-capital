...
if( !empty($layout_settings)){
	...
	$layout_left_sidebar = hcode_option_post('hcode_layout_left_sidebar');
	$layout_right_sidebar = hcode_option_post('hcode_layout_right_sidebar');	
}else{
...
switch ($layout_settings) {
	...
	case 'hcode_layout_both_sidebar':
		echo '</div>';
		echo '<div class="col-sm-6 col-xs-12 both-sidebar-left sidebar xs-margin-bottom-seven">';
			dynamic_sidebar($layout_left_sidebar);
		echo '</div>';
            echo '<div class="col-sm-6 col-xs-12 both-sidebar-right sidebar">';
			dynamic_sidebar($layout_right_sidebar);
		echo '</div>';
		break;
