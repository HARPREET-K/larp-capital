...
$layout_settings_class = (isset($hcode_options['hcode_general_settings']) && ( $hcode_options['hcode_general_settings'] == 'hcode_general_both_sidebar' || $hcode_options['hcode_general_settings'] == 'hcode_general_left_sidebar' || $hcode_options['hcode_general_settings'] == 'hcode_general_right_sidebar') ) ? ' hcode-list-view-three-col' : '';
// no image
...
echo '<div class="'.$infinite_scroll_main_class.'">';
    if( have_posts() ) {
        while ( have_posts() ) : the_post();
            ...
            echo '<div '.$hcode_post_classes.'>';
                echo '<div class="col-md-12 blog-listing blog-list-layout'.$layout_settings_class.'">';
                    ...
                    if( $hcode_show_thumbnail == 1 ){
                        if( !empty( $blog_image ) && $hcode_show_feature_image != 1 ){
                            echo '<div class="blog-post">';
                                echo '<div class="col-md-5 col-sm-6 col-xs-12 margin-six-bottom xs-margin-bottom-15px no-padding">';
                    ...
                    echo '<div class="blog-details col-md-7 col-sm-6 col-xs-12 margin-six-bottom xs-margin-bottom-35px">';
                        if( $hcode_enable_title == 1 ){
                            echo '<div class="blog-title entry-title"><a href="'.get_permalink().'" rel="bookmark">'.get_the_title().'</a></div>';
                        }
                        echo '<div class="blog-date margin-five-bottom">'.$hcode_show_author.$show_date.'</div>';
                        ...
                        if($post_type == 'post'):
                            echo '<div class="hcode-custom-meta margin-three-top sm-margin-six-top xs-no-margin-top">';
                                if($hcode_general_enable_button == 1){
                                    echo '<div class="hcode-continue-button"><a class="highlight-button btn btn-small xs-no-margin-bottom" href="'.get_permalink().'">'.$hcode_general_button_text.'</a></div>';
                                }
                                echo '<div class="hcode-show-likes">';
                ...
                if( $hcode_enable_separator == 1 ){
                    echo '<div class="col-md-12 col-sm-12 col-xs-12 margin-six-bottom xs-display-none"><div class="separator-line-thin bg-mid-gray"></div></div>';
                }
            echo '</div>';
        endwhile;
        if( $hcode_general_archive_page_enable_navigation == 1 ) {
