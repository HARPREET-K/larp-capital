...
switch ($layout_settings) {
	...
	case 'hcode_layout_both_sidebar':
        if( class_exists( 'WooCommerce' ) && is_cart() ){
		    echo '<div class="col-sm-12 both-content-center hcode-shopping-cart-both-column shopping-cart-content sm-margin-bottom-seven sm-no-padding">';
        }else{
            echo '<div class="col-sm-12 both-content-center sm-margin-bottom-seven">';
        }
	break;
