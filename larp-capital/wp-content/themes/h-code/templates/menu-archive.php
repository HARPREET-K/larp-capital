...
$hcode_header_layout = ( isset( $hcode_options['hcode_header_layout_general'] ) && !empty( $hcode_options['hcode_header_layout_general'] ) ) ? $hcode_options['hcode_header_layout_general'] : $hcode_header_layout_global;
...
if( $hcode_enable_header == 1 ){
    ...
    $hcode_header_logo_general = hcode_option( 'hcode_header_logo_general' );
    $get_general_logo_alt_text = $add_general_logo_alt_text = '';
    if( isset( $hcode_header_logo_general['id'] ) ) {
        $get_general_logo_alt_text = get_post_meta( $hcode_header_logo_general["id"], '_wp_attachment_image_alt', true );
    ...
    $hcode_header_light_logo_general = hcode_option( 'hcode_header_light_logo_general' );
    $get_header_light_logo_alt_text = $add_header_light_logo_alt_text = '';
    if( isset( $hcode_header_light_logo_general['id'] ) ) {
        $get_header_light_logo_alt_text = get_post_meta( $hcode_header_light_logo_general["id"], '_wp_attachment_image_alt', true );
    ...
    $hcode_retina_logo_general = hcode_option( 'hcode_retina_logo_general' );
    $get_retina_logo_alt_text = $add_retina_logo_alt_text = '';
    if( isset( $hcode_retina_logo_general['id'] ) ) {
        $get_retina_logo_alt_text = get_post_meta( $hcode_retina_logo_general["id"], '_wp_attachment_image_alt', true );
        $add_retina_logo_alt_text = $get_retina_logo_alt_text ? $get_retina_logo_alt_text : get_bloginfo( 'name' );
    }

    /* Get Alt Text For Header Retina Logo */
    $hcode_retina_logo_light_general = hcode_option( 'hcode_retina_logo_light_general' );
    $get_retina_light_logo_alt_text = $add_retina_light_logo_alt_text = '';
    if( isset( $hcode_retina_logo_light_general['id'] ) ) {
        $get_retina_light_logo_alt_text = get_post_meta( $hcode_retina_logo_light_general["id"], '_wp_attachment_image_alt', true );
    ...
    $hcode_header_logo = ( isset( $hcode_options['hcode_header_logo_general']['url'] ) && !empty( $hcode_options['hcode_header_logo_general']['url'] ) ) ? $hcode_options['hcode_header_logo_general']['url'] : $hcode_header_logo_global;

    $hcode_header_light_logo_global = !empty( $hcode_options['hcode_header_light_logo']['url'] ) ? $hcode_options['hcode_header_light_logo']['url'] : '';
    $hcode_header_light_logo = ( isset( $hcode_options['hcode_header_light_logo_general']['url'] ) && !empty( $hcode_options['hcode_header_light_logo_general']['url'] ) ) ? $hcode_options['hcode_header_light_logo_general']['url'] : $hcode_header_light_logo_global;

    $header_menu_global = !empty( $hcode_options['hcode_header_menu'] ) ? $hcode_options['hcode_header_menu'] : '';
    $header_menu = ( isset( $hcode_options['hcode_header_menu_general'] ) && !empty( $hcode_options['hcode_header_menu_general'] ) ) ? $hcode_options['hcode_header_menu_general'] : $header_menu_global;

    $header_secondary_menu_global = !empty( $hcode_options['hcode_header_secondary_menu'] ) ? $hcode_options['hcode_header_secondary_menu'] : '';
    $header_secondary_menu = ( isset( $hcode_options['hcode_header_secondary_menu_general'] ) && !empty( $hcode_options['hcode_header_secondary_menu_general'] ) ) ? $hcode_options['hcode_header_secondary_menu_general'] : $header_secondary_menu_global;

    $hcode_header_text_color_global = !empty( $hcode_options['hcode_header_text_color'] ) ? ' '.$hcode_options['hcode_header_text_color'] : '';
    $hcode_header_text_color = ( isset( $hcode_options['hcode_header_text_color_general'] ) && !empty( $hcode_options['hcode_header_text_color_general'] ) ) ? ' '.$hcode_options['hcode_header_text_color_general'] : $hcode_header_text_color_global;
    ...
    $retina = ( isset( $hcode_options['hcode_retina_logo_general']['url'] ) && !empty( $hcode_options['hcode_retina_logo_general']['url'] ) ) ? $hcode_options['hcode_retina_logo_general']['url'] : $retina_global;

    $retina_light_global = !empty( $hcode_options['hcode_retina_logo_light']['url'] ) ? $hcode_options['hcode_retina_logo_light']['url'] : '';
    $retina_light = ( isset( $hcode_options['hcode_retina_logo_light_general']['url'] ) && !empty( $hcode_options['hcode_retina_logo_light_general']['url'] ) ) ? $hcode_options['hcode_retina_logo_light_general']['url'] : $retina_light_global ;
    ...
    $retina_width = ( isset( $hcode_options['hcode_retina_logo_width_general'] ) && !empty( $hcode_options['hcode_retina_logo_width_general'] ) ) ? 'width:'.$hcode_options['hcode_retina_logo_width_general'].'; ' : $retina_width_global;
    ...
    $retina_height = ( isset( $hcode_options['hcode_retina_logo_height_general'] ) && !empty( $hcode_options['hcode_retina_logo_height_general'] ) ) ? 'max-height:'.$hcode_options['hcode_retina_logo_height_general'].';' : $retina_height_global;
    $r_style  = '';
    ...
    /* H-Code V1.8.6 */
    $hcode_non_sticky_menu = !empty( $hcode_options['hcode_non_sticky_menu_general'] ) ? $hcode_options['hcode_non_sticky_menu_general'] : '';
    ...
    /* H-Code V1.9.4 */
    $hcode_top_header_space = !empty( $hcode_options['hcode_top_header_space_general'] ) ? $hcode_options['hcode_top_header_space_general'] : '';
    ...
    $hcode_remove_top_header_space = !empty( $hcode_options['hcode_remove_top_header_space_general'] ) ? $hcode_options['hcode_remove_top_header_space_general'] : '';
    ...
    $header_logo_position = isset( $hcode_options['hcode_header_logo_position_general'] ) && !empty( $hcode_options['hcode_header_logo_position_general'] ) ? $hcode_options['hcode_header_logo_position_general'] : $hcode_header_logo_position_global;
    
    $hcode_header_full_width = !empty( $hcode_options['hcode_header_full_width_general'] ) ? $hcode_options['hcode_header_full_width_general'] : '';
    $hcode_header_menu_position = !empty( $hcode_options['hcode_header_menu_position_general'] ) ? $hcode_options['hcode_header_menu_position_general'] : '';
    ...
    $menu_image = ( isset( $hcode_options['hcode_menu_image_general'] ) && !empty( $hcode_options['hcode_menu_image_general'] ) ) ? $hcode_options['hcode_menu_image_general'] : $menu_image_global;
    ...
    $menu_logo = ( isset( $hcode_options['hcode_menu_logo_general'] ) && !empty( $hcode_options['hcode_menu_logo_general'] ) ) ? $hcode_options['hcode_menu_logo_general'] : $menu_logo_global;
    ...
    $enable_menu_social_icons = ( isset( $hcode_options['hcode_enable_menu_social_icons_general'] ) && !empty( $hcode_options['hcode_enable_menu_social_icons_general'] ) ) ? $hcode_options['hcode_enable_menu_social_icons_general'] : $hcode_enable_menu_social_icons_global;

    $hcode_menu_social_sidebar_global = !empty( $hcode_options['hcode_menu_social_sidebar'] ) ? $hcode_options['hcode_menu_social_sidebar'] : '';
    $menu_social_sidebar = ( isset( $hcode_options['hcode_menu_social_sidebar_general'] ) && !empty( $hcode_options['hcode_menu_social_sidebar_general'] ) ) ? $hcode_options['hcode_menu_social_sidebar_general'] : $hcode_menu_social_sidebar_global;
    ...
    $enable_menu_separator = ( isset( $hcode_options['hcode_enable_menu_separator_general'] ) && !empty( $hcode_options['hcode_enable_menu_separator_general'] ) ) ? $hcode_options['hcode_enable_menu_separator_general'] : $hcode_enable_menu_separator_global;
    ...
    if( $hcode_header_layout == 'headertype9' ) {
        ...
        if( is_tax( 'portfolio-category' ) || is_tax( 'portfolio-tags' ) || is_post_type_archive( 'portfolio' ) ){
            ...
            if( $enable_title == '1' ){
                $hcode_options = get_option( 'hcode_theme_setting' );
                $enable_title = ( isset( $hcode_options['hcode_enable_category_title_wrapper'] ) ) ? $hcode_options['hcode_enable_category_title_wrapper'] : '';
            }
        } else {
            $enable_title = hcode_option('hcode_enable_archive_title_wrapper');
            if( $enable_title == '1' ){
                $hcode_options = get_option( 'hcode_theme_setting' );
                $enable_title = ( isset( $hcode_options['hcode_enable_archive_title_wrapper'] ) ) ? $hcode_options['hcode_enable_archive_title_wrapper'] : '';
            }
        }
                        ...
                        echo '<div class="hcode-hamburger-menu no-transition">';
                            ...
                            if( $hcode_header_search == 1 || $hcode_header_cart == 1 ){
                                echo '<div class="search-cart-header">';
                                    if( $hcode_header_cart == 1 && is_active_sidebar( $hcode_header_mini_cart_general ) ){
                                        echo '<div class="top-cart">';
                                            dynamic_sidebar( $hcode_header_mini_cart_general );
                                        echo '</div>';
                                    }
        ...
        echo '<nav class="navbar navbar-default navbar-fixed-top nav-transparent overlay-nav sticky-nav '.$classes.$hcode_header_text_color." ".$enable_sticky.'" data-menu-hover-delay="'.$hcode_menu_hover_delay.'"'.$hcode_header_top_offset.'>';
            echo '<div class="nav-header-container '.$container_class.'">';
                echo '<div class="row">';
                    ...
                    if( $hcode_header_search == 1 || $hcode_header_cart == 1 ){
                        echo '<div class="search-cart-header">';
                            if( $hcode_header_cart == 1 && $hcode_header_mini_cart_general ){
                                echo '<div class="top-cart">';
                                    dynamic_sidebar( $hcode_header_mini_cart_general );
                                echo '</div>';
                            }
                            ...
                            if( $hcode_header_search == 1 ){
                                echo '<div id="top-search">';
                                    echo '<a href="#search-header" class="header-search-form">';
